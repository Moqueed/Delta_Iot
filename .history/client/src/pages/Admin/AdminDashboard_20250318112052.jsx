    ...
    <Col key={section.key} xs={24} sm={12} md={8} lg={4} style={{ display: "flex", justifyContent: "center" }}>
      <Card
        ...
        style={{
          ...
          backgroundColor: "#d0e9af", // Original color style
      ...
      >
        <div style={{ fontSize: "40px", marginBottom: "5px", color: "#1890ff" }}>{section.icon}</div>
  ...
  return (
    <div
      style={{
        ...
        width: "100vw",
        padding: "20px",
        backgroundColor: "#eae2b7", // Background color from image
        display: "flex",
        flexDirection: "column",
        alignItems: "center",
