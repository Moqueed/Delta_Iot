      ...
      <div style={{ flex: 1, padding: "20px", backgroundColor: "#f0f2f5" }}>
        {selectedPosition ? (
          <>
            ...
            <Input addonBefore="vacancy" value={selectedPosition.vacancy} style={{ marginBottom: "10px" }} />
            ...
            <Row gutter={8} style={{ marginBottom: "10px" }}>
              <Col span={8}>
                <Input addonBefore="HRs" value={selectedPosition.manager} readOnly style={{ textAlign: "right" }} />
              </Col>
              <Col span={16}>
                <Select
                  style={{ width: "100%" }}
                  value={selectedPosition.manager}
                  onChange={(value) => setSelectedPosition({ ...selectedPosition, manager: value })}
                >
