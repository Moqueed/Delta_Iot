...
const AdminDashboard = () => {
  ...
  const hrSections = [
    { key: "vacancies", icon: <FileTextOutlined />, title: "Vacancies", borderColor: "#FFD700" },
  ...
  return (
    <div style={{ height: "100vh", width: "100vw", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: "#ffffff" }}>
      <Title level={2} style={{ marginBottom: "20px" }}>HR's CREDENTIAL</Title>
      <Row gutter={[32, 32]} style={{ width: "100%", padding: "20px" }} justify="center" align="middle">
        {hrSections.map(renderSection)}
      </Row>
      <Title level={2} style={{ marginBottom: "20px" }}>ADMIN CREDENTIAL</Title>
      <Row gutter={[32, 32]} style={{ width: "100%", padding: "20px" }} justify="center" align="middle">
