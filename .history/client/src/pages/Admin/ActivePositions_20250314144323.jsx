        ...
        {selectedPosition ? (
          <>
            ...
            <Row gutter={8} style={{ marginBottom: "10px" }}>
              <Col span={12}>
                <Input addonBefore="Department" value={selectedPosition.department} readOnly />
              </Col>
              <Col span={12}>
                <Select
                  style={{ width: "100%" }}
            ...
            <Input addonBefore="Manager" value={selectedPosition.manager} style={{ marginBottom: "10px" }} />
