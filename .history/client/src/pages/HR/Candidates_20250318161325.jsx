...
import { Form, Input, Select, Button, DatePicker, message, Spin, InputNumber } from "antd";
import { addCandidate, updateCandidate, getCandidates } from "../api/candidateApi";
      ...
      >
        ...
        <Form.Item name="department" label="Department" rules={[{ required: true }]}>
          <Select placeholder="Select department">
            {["IT", "EMDB", "HIGH", "Financial", "Python"].map((dept) => (
