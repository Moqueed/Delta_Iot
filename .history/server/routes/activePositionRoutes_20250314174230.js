...
router.post("/add-position", async (req, res) => {
  try {
    const { position, skills, department, vacancy, manager, minimum_experience, maximum_experience, job_description, HRs } = req.body;

    // Ensure all fields are provided
    if (!position || !skills || !department || !vacancy || !manager || !minimum_experience || !maximum_experience || !job_description || !HRs) {
